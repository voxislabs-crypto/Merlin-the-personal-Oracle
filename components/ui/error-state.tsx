...
export function ErrorState({
  ...
  const variants = {
    error: {
      ...
      defaultMessage: 'Merlin hit a snag. Try again in a moment — your chart data is still safe.',
    },
    warning: {
      icon: AlertCircle,
      ...
      defaultMessage: 'Something needs your attention before we can continue.',
    },
    notFound: {
      icon: AlertCircle,
      ...
      defaultMessage: 'That page isn’t here. Head home and try another path.',
    },
  };
