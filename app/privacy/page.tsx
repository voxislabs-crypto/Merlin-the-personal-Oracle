    ...
    <div className="max-w-4xl mx-auto px-6 py-16 text-gray-100">
      ...
      <div className="space-y-8 text-gray-300 leading-relaxed">
        ...
        <section>
          ...
          <p>
            We may update this Policy. Check back periodically. Questions? Email: <a href="mailto:kai@voxislabs.com" className="text-amber-400 hover:text-amber-300 underline">kai@voxislabs.com</a>
          </p>
